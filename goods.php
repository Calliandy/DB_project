            ...
            <div class="detail-box">
                <?php
                    try {
                        ...
                        $sql = "SELECT products.*, users.username FROM products JOIN users ON products.sellerID = users.userID";
                        ...
                        // 計算符合搜尋條件的總共的資料筆數
                        $total_records_stmt = $db->prepare("SELECT COUNT(*) FROM products");
                        if (!empty($search_keyword)) {
                            $total_records_stmt = $db->prepare("SELECT COUNT(*) FROM products WHERE productName LIKE :keyword");
